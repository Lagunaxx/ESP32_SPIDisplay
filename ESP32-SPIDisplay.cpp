...
namespace Device{
	 ...
	 *******************************************************************************/
		//Screen* Driver;
/*		void init(T_DispCoords _W, T_DispCoords _H){
...
//		  textbgcolor = bitmap_bg = 0x0000; // Black
		  ...
		  _swapBytes = false;   // Do not swap color bytes by default
...
//		  _ypivot = 0;
		...
		*/
		  ...
		  return (((uint32_t)0) | (r<<16) | (g<<8) | b); //retuns 0x00rrggbb
		...
		***************************************************************************************/
		void Screen::readRect(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint16_t *data)
		{
		...
		***************************************************************************************/
		void Screen::pushRect(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint16_t *data)
		{
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint16_t *data)
		{
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint16_t *data, uint16_t transp)
		{
...
/****************************************************************************************************************************
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, const uint16_t *data)
		{
		#ifdef ESP32
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, const uint16_t *data, uint16_t transp)
		{
		#ifdef ESP32
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint8_t *data, bool bpp8)
		{
		  if ((x >= _width) || (y >= (int32_t)_height)) return;
		...
		***************************************************************************************/
		void Screen::pushImage(T_DispCoords x, T_DispCoords y, T_DispCoords w, T_DispCoords h, uint8_t *data, uint8_t transp, bool bpp8)
		{
		  if ((x >= _width) || (y >= _height)) return;
		...
		***************************************************************************************/
		...
		void  Screen::readRectRGB(T_DispCoords x0, T_DispCoords y0, T_DispCoords w, T_DispCoords h, uint8_t *data)
		{
		#if defined(ESP32_PARALLEL)
		...
		***************************************************************************************/
		...
		void Screen::setAddrWindow(T_DispCoords x0, T_DispCoords y0, T_DispCoords w, T_DispCoords h)
		{
		  //spi_begin();
			if(SPIStartWrite()){
