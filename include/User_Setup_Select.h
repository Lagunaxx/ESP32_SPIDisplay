...
#define DEBUG_PRINT_SERIAL			// Show several debug info in terminal over Serial-interface (USB, etc)

#include "User_Setup.h"           // Default setup is root library folder

#include "User_Setups/TTGO_T_Display.h"    // Setup file for TTGO T-Display board
